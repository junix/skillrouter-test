...
- 读者问题：skillrouter 的代码从哪里进入、由哪些分区构成、怎样运行并如何验证？
...
- README：`README.md`
- manifests：`justfile`, `pyproject.toml`
- 源码规模：13 个源码文件、1805 个非空文本行
- 测试边界：8 个路径命中测试规则的已跟踪文件
- 最近提交：2026-08-29 docs: 更新架构文档; 2026-08-29 docs: 架构文档英文内容翻译为中文; 2026-08-26 docs: relocate architecture infographic to docs/infographics
